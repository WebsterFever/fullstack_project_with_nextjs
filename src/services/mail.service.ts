...
const mailgenGenerator = new Mailgen({
    theme:'default',
    product:{ name: "Project FullStack Kenzie - Web", link: "http://localhost:3000"}});
...
export class EmailService{
    ...
    resetPassword(userEmail:string, userName:string, resetToken:string){
        ...
        const emailTemplate = { to: userEmail, subject:"Project FullStack Kenzie - Password Reset Extra!", text:emailBodyFinally};
